...
type EnforceQL interface {
	Enforce(query string, allowedTenantLabelValues []string, config interface{}) (string, error)
}
...
func enforceRequest(r *http.Request, enforce EnforceQL, allowedTenantLabelValues []string, matchWord string, config interface{}) error {
	switch r.Method {
	case http.MethodGet:
...
func enforceGet(r *http.Request, enforce EnforceQL, allowedTenantLabelValues []string, matchWord string, config interface{}) error {
...
func enforcePost(r *http.Request, enforce EnforceQL, allowedTenantLabelValues []string, matchWord string, config interface{}) error {
